...
if __name__ == '__main__':
    ...
    def experiment(pre, limits, fname, long_title, unfrozen):
        ...
        for i in range(1, 11):
            if (pre):
                ...
                model_pth = os.path.join(storage_path, f"models/ztf_classifier_bts{i}.weights.h5") #_bts
    ...
    experiment(pre=True, limits=limits, fname='bts_ft_output_five1', long_title='BTS Fine Tuned Last Two', unfrozen=['output'])
    ...
    experiment(pre=False, limits=limits, fname='bts_direct_five1', long_title='BTS Direct Training', unfrozen=None)
